...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="/application/themes/frontend/assets/images/favicon.ico">
    <!-- Bootstrap -->
    <link href="https://cms-codenite.ru/application/themes/frontend/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Icons -->
    <link href="/application/themes/frontend/assets/css/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v3.0.6/css/line.css">
    <!-- Slider -->
    <link rel="stylesheet" href="/application/themes/frontend/assets/css/tiny-slider.css"/>
    <!-- Main Css -->
    <link href="/application/themes/frontend/assets/css/style.css" rel="stylesheet" type="text/css" id="theme-opt" />
    <link href="/application/themes/frontend/assets/css/colors/default.css" rel="stylesheet" id="color-opt">
...
<header id="topnav" class="defaultscroll sticky">
    <div class="container">
        <!-- Logo container-->
        <a class="logo" href="/">
            <img src="/application/themes/frontend/assets/images/logo-dark.png" height="24" class="logo-light-mode" alt="">
            <img src="/application/themes/frontend/assets/images/logo-light.png" height="24" class="logo-dark-mode" alt="">
        </a>
        <!-- Logo End -->
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                            <a href="#" class="logo-footer">
                                <img src="/application/themes/frontend/assets/images/logo-light.png" height="24" alt="">
                            </a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <ul class="list-unstyled text-sm-end mb-0">
                        <li class="list-inline-item"><a href="javascript:void(0)"><img src="/application/themes/frontend/assets/images/payments/american-ex.png" class="avatar avatar-ex-sm" title="American Express" alt=""></a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"><img src="/application/themes/frontend/assets/images/payments/discover.png" class="avatar avatar-ex-sm" title="Discover" alt=""></a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"><img src="/application/themes/frontend/assets/images/payments/master-card.png" class="avatar avatar-ex-sm" title="Master Card" alt=""></a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"><img src="/application/themes/frontend/assets/images/payments/paypal.png" class="avatar avatar-ex-sm" title="Paypal" alt=""></a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"><img src="/application/themes/frontend/assets/images/payments/visa.png" class="avatar avatar-ex-sm" title="Visa" alt=""></a></li>
                    </ul>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
...
<div class="offcanvas offcanvas-end bg-white shadow" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header p-4 border-bottom">
        <h5 id="offcanvasRightLabel" class="mb-0">
            <img src="/application/themes/frontend/assets/images/logo-dark.png" height="24" class="light-version" alt="">
            <img src="/application/themes/frontend/assets/images/logo-light.png" height="24" class="dark-version" alt="">
        </h5>
    ...
    <div class="offcanvas-body p-4">
        <div class="row">
            <div class="col-12">
                <img src="/application/themes/frontend/assets/images/contact.svg" class="img-fluid d-block mx-auto" style="max-width: 256px;" alt="">
...
<!-- javascript -->
<script src="/application/themes/frontend/assets/js/bootstrap.bundle.min.js"></script>
<!-- SLIDER -->
<script src="/application/themes/frontend/assets/js/tiny-slider.js "></script>
<!-- Icons -->
<script src="/application/themes/frontend/assets/js/feather.min.js"></script>
<!-- Switcher -->
<script src="/application/themes/frontend/assets/js/switcher.js"></script>
<!-- Main Js -->
<script src="/application/themes/frontend/assets/js/plugins.init.js"></script><!--Note: All init js like tiny slider, counter, countdown, maintenance, lightbox, gallery, swiper slider, aos animation etc.-->
<script src="/application/themes/frontend/assets/js/app.js"></script><!--Note: All important javascript like page loader, menu, sticky menu, menu-toggler, one page menu etc. -->
</body>
</html>